  ...
  <section id="gallery">
    ...
    <div class="grid grid-cols-4 gap-4 mt-4">
      <template v-for="gallery in galeries" :key="gallery.id">
        <div @click="changeDefaultImage(gallery.image)" class="overflow-hidden cursor-pointer rounded-2xl" :class="{'ring-2 ring-indigo-500': defaultImage == gallery.image}">
