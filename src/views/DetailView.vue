...
export default {
    ...
    methods: {
        async getSingleProduct(){
            try {
                const response = await axios.get('https://zullkit-backend.buildwithangga.id/api/products?id='+this.$route.params.id)
    ...
    computed: {
        featuresSplit(){
          const plainFeatures = this.data.features
          return plainFeatures.split(",")
        },
        getUser(){
    ...
    <div class="container p-2 mx-auto my-10 max-w-7xl">
      <div class="flex flex-row flex-wrap py-4">
        <main role="main" class="w-full px-4 pt-1 sm:w-2/3 md:w-2/3">
          ...
          <Galery :galleries="data.galleries" :thumb="data.thumbnails" />
        ...
        <aside class="w-full px-4 sm:w-1/3 md:w-1/3">
          <div class="sticky top-0 w-full pt-4 md:mt-24">
            <div class="p-6 border rounded-2xl">
              <div class="mb-4" v-if="data.is_figma == 1">
                <div class="flex mb-2">
                  <div>
              ...
              <div class="mb-4" v-if="data.is_sketch == 1">
                <div class="flex mb-2">
                  <div>
              ...
              <div>
                ...
                <ul class="mb-6 text-gray-500" v-if="data.name">
                  <li class="mb-2" v-for="(feature, i) in featuresSplit" :key="i">
                    {{ feature }}
                    <img
              ...
              <a v-if="getLoggedIn == true && getUser.data.subscription.length > 0"
                :href="data.file"
